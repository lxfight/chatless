...
const BRAND_LOGO_RULES: readonly BrandRule[] = [
  ...
  { logoKey: 'qwen', patterns: [/\bqwen\b/i, /\bqwq\b/i] },
  { logoKey: 'mistral', patterns: [/\bmistral\b/i, /\bmixtral\b/i, /\bcodestral\b/i, /\bpixtral\b/i] },
  { logoKey: 'groq', patterns: [/\bgroq\b/i] },
  { logoKey: 'zhipu', patterns: [/\bglm-?\d/i, /\bzhipu\b/i] },
  { logoKey: 'moonshot', patterns: [/\bmoonshot\b/i, /\bkimi\b/i] },
  { logoKey: 'yi', patterns: [/\byi-\w+/i, /01-ai\//i] },
  { logoKey: 'llama', patterns: [/\bllama\b/i] },
  { logoKey: 'voyageai', patterns: [/\bvoyage\b/i] },
  { logoKey: 'cohere', patterns: [/\bcohere\b/i, /command-r/i] },
  { logoKey: 'perplexity', patterns: [/\bperplexity\b/i, /\bsonar\b/i, /\bpplx\b/i] },
  { logoKey: 'jina', patterns: [/\bjina\b/i] },
  { logoKey: 'stability', patterns: [/stability/i, /stable[- ]?diffusion|\bsd[23x]?/i] },
  { logoKey: 'ideogram', patterns: [/\bideogram\b/i] },
  { logoKey: 'flux', patterns: [/\bflux\b/i] },
  { logoKey: 'imagen', patterns: [/\bimagen\b/i] },
  { logoKey: 'luma', patterns: [/\bluma\b/i, /\bphoton\b/i] },
  { logoKey: 'runway', patterns: [/\brunway\b/i] },
  { logoKey: 'sora', patterns: [/\bsora\b/i] },
  { logoKey: 'veo', patterns: [/\bveo\b/i] },
  { logoKey: 'kling', patterns: [/\bkling\b/i] },
  { logoKey: 'pixverse', patterns: [/\bpixverse\b/i] },
  { logoKey: 'hunyuan', patterns: [/\bhunyuan\b/i] },
  { logoKey: 'doubao', patterns: [/\bdoubao\b/i] },
  { logoKey: 'baichuan', patterns: [/\bbaichuan\b/i] },
  { logoKey: 'reka', patterns: [/\breka\b/i] },
  { logoKey: 'elevenlabs', patterns: [/\belevenlabs\b/i] },
  { logoKey: 'topazlabs', patterns: [/\btopazlabs\b/i] },
  { logoKey: 'clarity', patterns: [/\bclarity[- ]?upscaler\b/i] },
  { logoKey: 'cartesia', patterns: [/\bcartesia\b/i] },
  { logoKey: 'orpheus', patterns: [/\borpheus[- ]?tts\b/i] },
  { logoKey: 'playai', patterns: [/\bplayai\b/i] },
  { logoKey: 'unreal-speech', patterns: [/\bunreal[- ]?speech\b/i] },
  { logoKey: 'together', patterns: [/\btogether\b/i] },
  { logoKey: 'openrouter', patterns: [/\bopenrouter\b/i] },
  { logoKey: 'poe', patterns: [/\bpoe\b/i] },
];
